...
const galleryItems: Record<string, { label: string; items: { src: string; name: string }[] }> = {
  badges: {
    label: '徽章',
    items: [
      { src: '/assets/gallery-2026/徽章-郁金香.png', name: '郁金香' },
      { src: '/assets/gallery-2026/徽章-玉兰.png', name: '玉兰' },
      { src: '/assets/gallery-2026/徽章-樱花.png', name: '樱花' },
      { src: '/assets/gallery-2026/徽章-山茶.png', name: '山茶' },
      { src: '/assets/gallery-2026/徽章-杜鹃.png', name: '杜鹃' },
    ],
  },
  cards: {
    label: '透卡',
    items: [
      { src: '/assets/gallery-2026/透卡-玉兰.png', name: '玉兰' },
      { src: '/assets/gallery-2026/透卡-樱花.png', name: '樱花' },
    ],
  },
  charms: {
    label: '挂件',
    items: [
      { src: '/assets/gallery-2026/挂件-围观.png', name: '围观' },
      { src: '/assets/gallery-2026/挂件-点赞.png', name: '点赞' },
      { src: '/assets/gallery-2026/挂件-干饭.png', name: '干饭' },
      { src: '/assets/gallery-2026/挂件-皇帝驾到.png', name: '皇帝驾到' },
      { src: '/assets/gallery-2026/挂件-敲木鱼.png', name: '敲木鱼' },
    ],
  },
  others: {
    label: '其他',
    items: [
      { src: '/assets/gallery-2026/礼品袋.png', name: '礼品袋' },
      { src: '/assets/gallery-2026/海报.png', name: '海报' },
    ],
  },
}
