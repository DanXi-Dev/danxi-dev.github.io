...
使用旦挞团队发布的旦挞校园助手副本意味着您同意本使用协议。

旦挞校园助手依据 GPL-3.0 协议在 GitHub 开源，您可以从[项目首页](https://github.com/DanXi-Dev/DanXi)获得旦挞校园助手的源代码。

- [旦挞校园助手隐私政策](/doc/app-privacy)；
- 旦挞团队发布的旦挞校园助手副本仅供学习交流使用，您对于您使用旦挞团队发布的旦挞校园助手副本的一切行为承担一切责任；
- 旦挞团队可以随时修改其发布的旦挞校园助手副本使用协议而恕不另行通知，您在使用旦挞团队发布的旦挞校园助手副本时应履行注意本条款变更的义务。
